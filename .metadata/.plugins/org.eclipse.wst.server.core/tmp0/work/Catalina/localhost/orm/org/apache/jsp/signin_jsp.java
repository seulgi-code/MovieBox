 ...
 * Generated at: 2020-08-01 20:32:27 UTC
...
public final class signin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("//로그인 제약사항\n");
      out.write("$(function(){\n");
      out.write(" $(\"button#loginCk\").click(function(){\n");
      out.write("\tif($(\"input#idCk\").val()==\"\"){\n");
      out.write("\t\talert(\"아이디 입력하세요\");\n");
      out.write("\t\t$(\"input#idCk\").focus();\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tif($(\"input#passwordCk\").val()==\"\"){\n");
      out.write("\t\talert(\"비밃번호 입력하세요\");\n");
      out.write("\t\t$(\"input#passwordCk\").focus();\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tif($(\"input#id\").val().length>0 && $(\"input#password\").val().length>0){\n");
      out.write("\t\tdocument.location.href='loginCheck.do?id='+$(\"input#id\").val()+'&password='+$(\"input#password\").val();\n");
      out.write("\t}\n");
      out.write("\t\n");
      out.write("});\n");
      out.write(" $(\"button#account\").click(function(){\n");
      out.write("\t\n");
      out.write("\tdocument.location.href='/orm/signup.jsp';\n");
      out.write("\t//window.location.href='/orm/jsp/signup.jsp'\n");
      out.write("});\n");
      out.write("});\n");
      out.write("</script>\n");
      ...
      out.write("\t\t\t\t<!-- <form class=\"login100-form validate-form flex-sb flex-w\" action=\"loginCheck.do\" method=\"post\"> -->\n");
      ...
      out.write("\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t<input class=\"input100\" type=\"password\" name=\"password\" id=\"password\" >\n");
      out.write("\t\t\t\t\t\t<span class=\"focus-input100\"></span>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t\t<button class=\"login100-form-btn\" id=\"loginCk\" name=\"loginCk\">\n");
      out.write("\t\t\t\t\t\t\tLogin\n");
      out.write("\t\t\t\t\t\t</button>\n");
      out.write("\t\t\t\t\t\t<button class=\"login100-form-btn\" id=\"account\" name=\"account\">\n");
      out.write("\t\t\t\t\t\t\tAccount Login\n");
      out.write("\t\t\t\t\t\t</button>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
